...
note: the .sh file extension is dropped, also, the script expects the application root to be /home/pi/apps/AlarmServer
...

2. Add the appropriate symbolic links to cause the script to be executed when the system goes down, or comes up. The simplest way of doing this is to use the Debian-specific command update-rc.d:
